...
<div class="section white-text" style="background: #B35458;">
    ...
    <div class="section center" style="padding: 40px;">
        ...
        <form action="../backends/admin/food-add.php" method="post">
            ...
            <div class="col s6" style="">
            <div class="input-field">
            <input id="name" name="name" type="text" class="validate" style="color: white; width: 70%" oninput="validateName()">
            <label for="name" style="color: white;"><b>Food Name :</b></label>
            </div>
            </div>
            ...
            var firstChar = nameInput.charAt(0);
            var specialChars = /^[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]*$/;

            if (!isNaN(firstChar) || specialChars.test(firstChar)) {
            alert("Food name cannot start with a number or special character!");
