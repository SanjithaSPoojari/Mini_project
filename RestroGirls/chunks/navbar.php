<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">Food Corner</a>
		      ...
		      <ul class="right hide-on-med-and-down">
		        ...
		        <li><a href="#" class="hvr-grow" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number 9982365401. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
	        ...
	        <li><a href="#" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number 9982365401. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
